...
# Generated: Wed Nov 18 10:47:08 2020
##################################################
...
class spectrum_analyzer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Spectrum Analysis")
        ...
        # Blocks
        ##################################################
        self._rf_gain_range = Range(0, 40, 1, 10, 200)
        self._rf_gain_win = RangeWidget(self._rf_gain_range, self.set_rf_gain, 'RF Gain', "counter_slider", float)
        self.top_layout.addWidget(self._rf_gain_win)
        self._freq_range = Range(1e6, 6e9, 1000, 3e6, 200)
        self._freq_win = RangeWidget(self._freq_range, self.set_freq, "freq", "counter_slider", float)
        self.top_layout.addWidget(self._freq_win)
        self._bandwidth_range = Range(1e6, 10e6, 1000, 2e6, 200)
